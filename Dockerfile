...
RUN rm -f /etc/apt/sources.list.d/debian.sources && \
    ...
    build-essential ca-certificates curl iputils-ping python3 python-is-python3 ripgrep ffmpeg gcc python3-dev python3-venv libffi-dev libolm-dev procps git openssh-client docker-cli xz-utils && \
