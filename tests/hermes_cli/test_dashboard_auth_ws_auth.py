...
class TestWsRequestIsAllowedGated:
    ...
    def test_non_loopback_peer_allowed_in_insecure_public_mode(
        ...
        FUXI-managed deployments additionally require the remote Chat WS
        opt-in flag.
        """
        monkeypatch.setenv("HERMES_DASHBOARD_ALLOW_REMOTE_CHAT_WS", "1")
    ...
    def test_non_loopback_peer_rejected_in_insecure_public_mode_without_flag(
        self,
        insecure_public_app,
        monkeypatch,
    ):
    ...
    def test_peer_rejected_on_explicit_non_loopback_bind_without_flag(
        self,
        insecure_explicit_host_app,
        monkeypatch,
    ):
