...
class APIServerAdapter(BasePlatformAdapter):
    ...
    def _http_route_table(self) -> List[tuple]:
        ...
        routes: List[tuple] = [
            ...
            ("GET", "/runtime/liveness", self._handle_runtime_liveness),
            ("POST", "/hermes-feedback-ingest", self._handle_fuxi_feedback_ingest),
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            # Goal execution is opt-in and must never start before the listener
