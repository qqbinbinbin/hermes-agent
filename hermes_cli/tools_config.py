...
def _get_platform_tools(
    ...
    *,
    ...
    # An explicitly saved empty list is an operator-authored deny-all contract.
    # FUXI profile runtimes use this to disable provider tool calling, so no
    # platform recovery, plugin, MCP, or context-engine default may re-add tools.
